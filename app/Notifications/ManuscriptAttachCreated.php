...
class ManuscriptAttachCreated extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line("Attachment {$this->attachFile->getType()['name']} has been uploaded in Manuscript {$this->manuscript->manuscript_attach_id}!")
    ...
    {
        return [
            'message' => "Attachment {$this->attachFile->getType()['name']} has been uploaded in Manuscript {$this->manuscript->manuscript_attach_id}!",
