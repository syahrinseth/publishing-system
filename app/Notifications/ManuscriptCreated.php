...
class ManuscriptCreated extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line("Manuscript {$this->manuscript->manuscript_no} has been created!")
    ...
    {
        return [
            'message' => "Manuscript {$this->manuscript->manuscript_no} has been created!",
