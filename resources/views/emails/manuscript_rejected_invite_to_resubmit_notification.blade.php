        ...
        <div class="flex items-center justify-center min-h-screen p-5 bg-gray-600 min-w-screen">
            <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                ...
                <div class="text-left mx-5">
                    ...
                    <br>
                    <p>Your manuscript entitled "{{ $manuscript->manuscript_no }}" has been successfully submitted online and is presently being given full consideration for publication in the JSSM.</p>
                    <p>Your paper has been received as a resubmitted manuscript, and will be assigned to the previous editor and reviewers if possible.</p>
                    <p>Thank you for submitting your manuscript to JSSM.</p>
                    <br>
                    <p>Sincerely,</p>
                    <p>JSSM Editorial Office</p>
                </div>
