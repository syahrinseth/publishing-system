        ...
        <template v-slot:header>
            <div class="lg:flex lg:items-center lg:justify-between">
                    ...
                    <Menu as="span" class="ml-3 relative sm:hidden">
                        ...
                        <MenuItems class="origin-top-right absolute mt-2 -mr-1 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                            <MenuItem v-slot="{ active }">
                                <Link :href="`/admin/manuscript-create`" :class="[active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700']" preserve-scroll>
                                <PlusIcon class="-ml-1 mr-2 h-5 w-5 text-gray-700" aria-hidden="true" />
                                Submit Manuscript
                            </Link>
                            </MenuItem>
                        </MenuItems>
