        ...
        <template v-slot:header>
            <div class="lg:flex lg:items-center lg:justify-between">
                    ...
                    <span class="hidden sm:block">
                        <Link :href="`/admin/user-create`" class="mx-1 inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
